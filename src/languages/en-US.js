	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INFO: [
				...
				'',
				'Some features of VATBot include:',
				'• ⛈️ METAR/TAF requests along with their decoded forms',
				'• ⚡ Get the active controllers at an airport along with ATIS information (if available)',
				'',
				'Some of the proposed features for VATBot include:',
				'• ✈️ Random flight generator based on airport popularity',
				'• 🛫 Check to see what controllers will be active between 2 airports',
				'',
				'If you want to help with the development of VATBot you can join the official Discord Server here: https://discord.gg/Htzybqa',
			],
